...
void MX_HRTIM1_Init(void)
{
  ...
  /*
   * Master CMP3 后移 160us，给 43us 的 late CNV 脉冲组保留结束裕量。
   * 旧参数保留用于回滚对照。
   */
